...
### Fixed
- Plugin ID now matches package name (`clawdbot-skill-flow`) to prevent mismatch warnings during installation
...
[0.2.1]: https://github.com/joshualelon/clawdbot-skill-flow/releases/tag/v0.2.1
[0.2.0]: https://github.com/joshualelon/clawdbot-skill-flow/releases/tag/v0.2.0
